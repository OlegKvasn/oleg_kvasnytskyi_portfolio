...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I'm Oleg. </span>
      ...
      >
        ...
        <a
          ...
          href="/O.Kvasnytsky Junior Front End Developer CV.pdf"
          download
        >
          Download CV{" "}
        ...
        <a
          ...
          href="https://www.linkedin.com/in/oleg-kvasnytskyi-5b1192245/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/OlegKvasn"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
